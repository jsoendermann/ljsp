function render(renderType) { 
    ...
    function vectorsDotProduct(v1, v2) {
        if (renderType === 1) {
            ...
            return Module._vectorsDotProduct_copy_by_value(v1.x, v1.y, v1.z, v2.x, v2.y, v2.z);
    ...
    function raySphereIntersectionPoint(r_original, s) {
        if (renderType === 1) {
            ...
            // Render using asm.js code generated by emscripten
            return Module._raySphereIntersectionPoint_copy_by_value(r_original.org.x, r_original.org.y, r_original.org.z, r_original.dir.x, r_original.dir.y, r_original.dir.z, s.pos.x, s.pos.y, s.pos.z, s.r);
        } else if (renderType === 0) {
