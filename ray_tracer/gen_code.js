...
var var_28 = 0.0, A = 0.0, env_var_1 = 0.0, hoisted_lambda_var_1 = 0.0, cont_1 = 0.0, s_r = 0.0, r_org_x = 0.0, B = 0.0, r_org_y = 0.0, r_org_z = 0.0;
...
var var_24 = 0.0, var_8 = 0.0, if_var_2 = 0.0, disc = 0.0, t0 = 0.0, var_13 = 0.0, var_19 = 0.0, var_17 = 0.0, var_23 = 0.0, var_9 = 0.0, A = 0.0, var_20 = 0.0, var_12 = 0.0, if_var_1 = 0.0, var_16 = 0.0, var_27 = 0.0, cont_1 = 0.0, if_var_0 = 0.0, var_15 = 0.0, ret_val_0 = 0.0, s_r = 0.0, var_10 = 0.0, var_21 = 0.0, B = 0.0, var_5 = 0.0, t_min = 0.0, C = 0.0, var_7 = 0.0, var_11 = 0.0, t1 = 0.0, var_25 = 0.0, var_18 = 0.0, var_6 = 0.0, t_max = 0.0, var_14 = 0.0;
...
var var_31 = 0.0, hoisted_lambda_var_2 = 0.0, var_32 = 0.0, r_org_x = 0.0, env_var_2 = 0.0, r_org_y = 0.0, r_org_z = 0.0, var_33 = 0.0;
...
D32[(~~+floor((+(env_var_2+(+4.0))))|0) << 2 >> 2] = r_org_x;
D32[(~~+floor((+(env_var_2+(+5.0))))|0) << 2 >> 2] = ro_dir_z;
D32[(~~+floor((+(env_var_2+(+6.0))))|0) << 2 >> 2] = r_org_y;
D32[(~~+floor((+(env_var_2+(+7.0))))|0) << 2 >> 2] = r_org_z;
...
var ftable0 = [expression];
var ftable11 = [raySphereIntersectionPoint];

return {expression: expression_copy, vectorsDotProduct: vectorsDotProduct_copy, raySphereIntersectionPoint: raySphereIntersectionPoint_copy};
}
