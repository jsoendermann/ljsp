...
% TODO: introducing lambdas in cps translation is slow and in the end generated more code than using k more than once
% TODO: making all params of type void* was a design mistake, made because it was done that way in asm.js and worked so chose same implementation (what problems does it cause)
% TODO: difficulties of the project: bad asm.js spec, llvm ir documentation also not readily available
% TODO: timeline of the project, where was time wasted (maybe much time in front end stages)
% TODO: meets requirement of evaluating asm.js for the restricted case of our needs
