...
\begin{itemize}
\item All classes that make up the Abstract Syntax tree can be found in \texttt{AST.scala}
\end{itemize}
...
\section{Structure and Detail of the Generated Code}
