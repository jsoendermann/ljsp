...
\begin{document}
% TODO LIB explain why both C and LLVM IR as targets. initially: LLVM IR to emscripten, for LLVM IR it turned to be easier to go via C, then: going from C was easier and equivalent to going from LLVM IR
% TODO LIB consistent names for stages
% TODO LIB the main idea of this paper is <this>, maybe in abstract
...
% TODO LIB give examples of LLVM IR code
...
\chapter{Design}
% TODO LIB Design chapter: History of development
...
% TODO LIB Page 27, 5.2.1: you "announce" that you will be explaining parsing there, but then you refer to the Implementation Chapter. I feel cheated ;o) ; mention parser combinators
\subsection{Parsing}
...
\label{fvarwrapping}
\end{figure}
This stage wraps @@@@ % example: def succ, let v1 = lambda... let v2 = succ, (v2 (v1 1)), b/c after closure conversion, lambdas need to be called differently
...
% TODO LIB give examples of this 
...
% TODO LIB add list of types in implementation chapter
...
% TODO LIB possibly talk about how LLVM IR is SSA code and C variables are accessed via pointer, how this language adds another layer of pointers that are saved in registers
...
% TODO HOME in design section, explain why LLVM IR code gets renumbered, does this have any effect on the running time?
...
% TODO LIB explain which method is which column
\begin{figure}[ht]
\begin{center}
...
% TODO LIB ast transformations would be nicer if the compiler generated the subtrees from short code snippets instead of creating the objects manually. maybe some other people have done work on this
...
% TODO LIB maybe say that LLVM IR was also hard to figure out
...
% TODO LIB in evaluation: stress that handwritten is benchmark, not javascript
...
% TODO LIB better explanation, links to racket, llvm
