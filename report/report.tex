...
We have designed LJSP, a dialect of LISP and written a compiler

\section{Future work}



% first: test ir code by implementing an interpreter, generally better test covarage, also test asm.js
% second: extends LJSP to be able to write entire raytracer in it (lists, complex data structures)
% optimisations, IR stages perfect framework for that
...
% TODO in evaluation: stress that handwritten is benchmark
